  ...
  return (
    <div className="contact-page-container">
      ...
      <p className="contact-page-description">
        Whether you’re a job seeker with questions or a recruiter looking for
        support, we’re here to help. Fill out the form below, and our team will
        get back to you promptly.
      </p>

      <form className="contact-form">
        {/* Render other input fields dynamically */}
        {otherInputs.map(({ labelName, type, name, placeholder, required }) => (
          <Input
            key={name}
            labelName={labelName}
            type={type}
      ...
      <div className="contact-info">
        <div className="contact-icon-wrapper">
          <Icon library="md" name="MdAlternateEmail" />
          <span>info@afghanKar.af</span>
        </div>
      </div>
    </div>
  );
